...
class Gateway(models.Model):
    ...
    GATEWAY_FUNCTION = ((FUNCTION_ZARINPAL, "Zarinpal"),)
    ...
    gateway_code = models.CharField(
        max_length=12, verbose_name=_("gateway code"), choices=GATEWAY_FUNCTION
    )
    ...
    def get_request_handler(self):
        handlers = {self.FUNCTION_ZARINPAL: zarinpal_request_handler}
        return handlers[self.gateway_code]

    def get_verify_handler(self):
        handlers = {self.FUNCTION_ZARINPAL: zarinpal_payment_checker}
        return handlers[self.gateway_code]
...
class Payment(models.Model):
    ...
    invoice_number = models.UUIDField(
        max_length=150, verbose_name=_("invoice number"), default=uuid.uuid4()
    )
